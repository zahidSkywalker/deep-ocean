...
export default function NewsletterSection() {
  ...
  return (
    <section id="newsletter" className="relative py-16 sm:py-20 bg-fw-500 overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-ag-300 font-body mb-8 max-w-lg mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <div className="relative flex-1">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-ag-400 pointer-events-none" />
              <Input
                type="email"
                ...
                required
                className="w-full h-12 pl-10 pr-4 bg-white border-ag-500/60 rounded-xl text-sm font-body placeholder:text-ag-400 focus-visible:ring-fw-300/30 focus-visible:border-fw-300"
              />
            </div>
            <Button
              type="submit"
              disabled={isSubmitted}
              className={`h-12 px-6 rounded-xl font-heading font-semibold shrink-0 transition-all ${
                isSubmitted
          ...
          <p className="text-xs text-ag-400 font-body mt-4">
